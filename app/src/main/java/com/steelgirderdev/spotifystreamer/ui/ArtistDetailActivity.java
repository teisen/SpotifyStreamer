...
public class ArtistDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            //TODO - i think we dont need this as we want to only show details upon selection
//            Bundle arguments = new Bundle();
//            arguments.putParcelable(Constants.EXTRA_ARTIST,
//                    (Parcelable) getIntent().getExtras().get(Constants.EXTRA_ARTIST));
//            ArtistDetailFragment fragment = new ArtistDetailFragment();
//            fragment.setArguments(arguments);
//            getSupportFragmentManager().beginTransaction()
//                    .add(R.id.fragment_detail_toptracks, fragment)
//                    .commit();
        }
    }
